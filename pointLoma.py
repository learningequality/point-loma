...
versionNumbers = ["0.3.1", "0.3.2", "0.4.0", "0.4.1", "0.4.2", "0.4.3",
                  "0.4.4", "0.4.5", "0.4.6", "0.4.7", "0.4.8", "0.4.9",
...
def run_tests(link, headless, count, output_file, created, versionName):
    ...
    if outputPath.is_file() and not created:
        ...
        if click.confirm(confirmMessage) is False:
    ...
    for numIteration in range(count):
        ...
        with open(filename) as json_data:
            ...
            dataRow = [timestamp, firstMeaningfulPaint, firstInteractive, consistentlyInteractive,
                       speedIndex, estimatedInputLatency, versionName]
            ...
            headerRow = ["Timestamp", "First Meaningful Paint", "First Interactive", "Consistently Interactive",
                         "Speed Index", "Estimated Input Latency", "Version"]
